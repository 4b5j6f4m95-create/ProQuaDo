...
**Noch nicht im Browser geprüft:** die beiden neuen Seiten aus Phase 5, `/offline` und `/sync/conflicts`, wurden nie in einem laufenden Browser geöffnet — beim Bau war Port 3002 durch einen fremden Dev-Server belegt. Server-Logik und Sync-Protokoll sind durch Integrationstests gegen echte Infrastruktur belegt, das Rendern dieser Seiten nur durch den Production-Build. Wer als Nächstes an ihnen arbeitet, sollte sie einmal manuell durchklicken, bevor er ihnen glaubt.
